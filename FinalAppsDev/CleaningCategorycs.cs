...
{
    public partial class CleaningCategorycs : Form
    {
        private CleaningCategory2? CleaningCategory2;
        ...
        private void CleaningCategorycs_Load(object sender, EventArgs e)
        {
     ...
     MessageBoxIcon.Warning);
        ...
        {
            if (CleaningCategory2 == null || CleaningCategory2.IsDisposed)
            {
                CleaningCategory2 = new CleaningCategory2(this); // pass reference
            }

            CleaningCategory2.Show();
            this.Hide();
        }
